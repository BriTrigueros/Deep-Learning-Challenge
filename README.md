...
[Module 21 Challenge files](https://static.bc-edx.com/data/dl-1-2/m21/lms/starter/charity_data.csv)
...
1. Start by uploading the starter file to Google Colab, then using the information provided in the Challenge files, follow the instructions to complete the preprocessing steps.
